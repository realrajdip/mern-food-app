        ...
        <div className="flex justify-between">
          ...
          <div className="flex justify-center  items-center gap-2 absolute right-7">
            <AiOutlineMinus
              ...
              className="border-2 border-gray-600 text-gray-600 hover:bg-green-500 hover:text-white hover:border-none rounded-md p-1 text-xl transition-all ease-linear cursor-pointer"
            />
            <span>{qty}</span>
            <AiOutlinePlus
              onClick={() =>
